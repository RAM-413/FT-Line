    ...
    return (
        ...
        <div className='max-w-[1200px] mx-auto relative mt-[-79px] px-3'>
            <div className='absolute flex top-[-59px] ml-3 left-[0] z-10 snap-proximity snap-x'>
                ...
                <button onClick={() => tabs('tab3')} className={`${data === "tab3" ? "bg-indigo-600 text-white" : "bg-white text-black"} transition w-[90px] md:w-[173.33px] h-[60px] px-5 py-4  border-b rounded-tr-[30px]  justify-center items-center gap-2.5 inline-flex text-center  text-[14px] sm:text-lg font-medium font-[Montserrat] leading-7`}>data</button>
            </div >
